...
uint256 hashGenesisBlock("0x65c11c7208cdf981bf794d1f9c9082c33ee0d79ff3264c6ef81e8dab15351134");
...
const string strMessageMagic = "VoteToken Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // VoteToken: 0.35 days
static const int64 nTargetSpacing = 15; // VoteToken: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal VoteToken miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VoteToken", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	*/
        ...
        // Genesis block
        const char* pszTimestamp = "Irish Independent 29/06/2012 €54m voting machines scrapped for €9 each";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("b6f38618594ad8f988aa54560c097c20e2585d2904e872db800a72ce7517e7f5"));
