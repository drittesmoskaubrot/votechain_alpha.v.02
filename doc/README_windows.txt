...
Setup
-----
Unpack the files into a directory and run votetoken-qt.exe.

If you have Microsoft Security Essentials, you need to add votetoken-qt.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select votetoken-qt.exe, OK, Save changes.
